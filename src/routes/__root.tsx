...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Kazu Toribio" },
      { name: "description", content: "Kazu's personal portfolio website showcases professional experience and services." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Kazu Toribio" },
      { property: "og:description", content: "Kazu's personal portfolio website showcases professional experience and services." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Kazu Toribio" },
      { name: "twitter:description", content: "Kazu's personal portfolio website showcases professional experience and services." },
